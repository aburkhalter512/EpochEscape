...
namespace Editor
{
    public class SaveManager
    {
        ...
        {
            Game.GameManager.Get().currentLevel = 1;
            Save();
        }
        ...
        public static void ResetGame()
        {
            ...
            Load();
            Game.GameManager.Get().caveUnlocked = true;
            Game.GameManager.Get().knightUnlocked = true;
        }
        ...
        public static void Save()
        {
            ...
            {
                case 0:
                    PlayerPrefs.SetInt("0Current Level", Game.GameManager.Get().currentLevel);
                    PlayerPrefs.SetInt("0Current Char", Game.GameManager.Get().m_currentCharacter);
                    //PlayerPrefs.SetInt ("0tutorial", GameManager.gGet ().tutorial == true ? 1 : 0);
                    break;
                case 1:
                    PlayerPrefs.SetInt("1Current Level", Game.GameManager.Get().currentLevel);
                    PlayerPrefs.SetInt("1Current Char", Game.GameManager.Get().m_currentCharacter);
                    //PlayerPrefs.SetInt ("1tutorial", GameManager.Get ().tutorial == true ? 1 : 0);
                    break;
                case 2:
                    PlayerPrefs.SetInt("2Current Level", Game.GameManager.Get().currentLevel);
                    PlayerPrefs.SetInt("2Current Char", Game.GameManager.Get().m_currentCharacter);
                    //PlayerPrefs.SetInt ("2tutorial", GameManager.Get ().tutorial == true ? 1 : 0);
                    break;
                case 3:
                    PlayerPrefs.SetInt("3Current Level", Game.GameManager.Get().currentLevel);
                    PlayerPrefs.SetInt("3Current Char", Game.GameManager.Get().m_currentCharacter);
                    //PlayerPrefs.SetInt ("3tutorial", GameManager.Get ().tutorial == true ? 1 : 0);
                    break;
            }

            PlayerPrefs.SetInt("CaveGirl", Game.GameManager.Get().caveUnlocked == true ? 1 : 0);
            PlayerPrefs.SetInt("Knight", Game.GameManager.Get().knightUnlocked == true ? 1 : 0);
            PlayerPrefs.SetInt("Ninja", Game.GameManager.Get().ninjaUnlocked == true ? 1 : 0);
            PlayerPrefs.SetInt("Astronaut", Game.GameManager.Get().astroUnlocked == true ? 1 : 0);
            PlayerPrefs.SetInt("Mummy", Game.GameManager.Get().mumUnlocked == true ? 1 : 0);
            PlayerPrefs.SetInt("Robot", Game.GameManager.Get().robUnlocked == true ? 1 : 0);
            PlayerPrefs.SetInt("Ninja Memo", Game.GameManager.Get().ninjaMemo);
            PlayerPrefs.SetInt("Astro Memo", Game.GameManager.Get().astroMemo);
            PlayerPrefs.SetInt("Mummy Memo", Game.GameManager.Get().mumMemo);
            PlayerPrefs.SetInt("Robot Memo", Game.GameManager.Get().robMemo);
        }
        ...
        public static void LoadGame()
        {
            ...
            {
                case 0:
                    Game.GameManager.Get().currentLevel = PlayerPrefs.GetInt("0Current Level");
                    Game.GameManager.Get().m_currentCharacter = PlayerPrefs.GetInt("0Current Char");
                    //GameManager.Get ().tutorial = PlayerPrefs.GetInt ("0tutorial") == 1 ? true : false;
                    break;
                case 1:
                    Game.GameManager.Get().currentLevel = PlayerPrefs.GetInt("1Current Level");
                    Game.GameManager.Get().m_currentCharacter = PlayerPrefs.GetInt("1Current Char");
                    //GameManager.Get ().tutorial = PlayerPrefs.GetInt ("1tutorial") == 1 ? true : false;
                    break;
                case 2:
                    Game.GameManager.Get().currentLevel = PlayerPrefs.GetInt("2Current Level");
                    Game.GameManager.Get().m_currentCharacter = PlayerPrefs.GetInt("2Current Char");
                    //GameManager.Get ().tutorial = PlayerPrefs.GetInt ("2tutorial") == 1 ? true : false;
                    break;
                case 3:
                    Game.GameManager.Get().currentLevel = PlayerPrefs.GetInt("3Current Level");
                    Game.GameManager.Get().m_currentCharacter = PlayerPrefs.GetInt("3Current Char");
        ...
        {
            Game.GameManager.Get().caveUnlocked = PlayerPrefs.GetInt("CaveGirl") == 1 ? true : false;
            Game.GameManager.Get().knightUnlocked = PlayerPrefs.GetInt("Knight") == 1 ? true : false;
            Game.GameManager.Get().ninjaUnlocked = PlayerPrefs.GetInt("Ninja") == 1 ? true : false;
            Game.GameManager.Get().mumUnlocked = PlayerPrefs.GetInt("Mummy") == 1 ? true : false;
            Game.GameManager.Get().robUnlocked = PlayerPrefs.GetInt("Robot") == 1 ? true : false;
            Game.GameManager.Get().ninjaMemo = PlayerPrefs.GetInt("Ninja Memo");
            Game.GameManager.Get().astroMemo = PlayerPrefs.GetInt("Astro Memo");
            Game.GameManager.Get().mumMemo = PlayerPrefs.GetInt("Mummy Memo");
            Game.GameManager.Get().robMemo = PlayerPrefs.GetInt("Robot Memo");
